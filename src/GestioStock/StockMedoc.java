...
public class StockMedoc extends javax.swing.JFrame {
	...
	private JTextField JtextField_Search_Medoc;
   ...
   // All Button and design Update
    private void initComponents() {
        ...
        lblNewLabel_11 = new JLabel("Stock des m\u00E9dicaments");
		...
		JtextField_Search_Medoc = new JTextField();
		JtextField_Search_Medoc.addKeyListener(new KeyAdapter() {
			@Override
			public void keyPressed(KeyEvent e) {
				DefaultTableModel model = (DefaultTableModel)jTable_Display_Medoc.getModel();
				String search = JtextField_Search_Medoc.getText();
				TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(model);
				jTable_Display_Medoc.setRowSorter(tr);
				tr.setRowFilter(RowFilter.regexFilter(search));
			}
		});
		JtextField_Search_Medoc.setColumns(10);
		
		JLabel lblNewLabel_15 = new JLabel("Recherche");
				...
				.addGroup(gl_jPanel1.createSequentialGroup()
					...
					.addGroup(gl_jPanel1.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_jPanel1.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(JtextField_Search_Medoc, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addGap(37))))
		);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StockMedoc window = new StockMedoc();
